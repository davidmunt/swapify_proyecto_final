...
import 'package:swapify/presentation/widgets/widget_fecha_nacimiento.dart';
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    ...
                    int telNumberParsed = int.parse(telNumber);
                    ...
                    if (name.isEmpty) {
                      ...
                      return;
                    } else if (int.tryParse(telNumber) == null) {
                    ...
                    //esto hacerlo despues de hacer el login
                    //context.read<UserBloc>().add(SaveUserInfoButtonPressed(uid: state.id ?? "XXKH9879"));
                  },
