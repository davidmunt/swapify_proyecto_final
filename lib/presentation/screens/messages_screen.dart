            ...
            return BlocBuilder<ChatBloc, ChatState>(
              builder: (context, chatState) {
                if (chatState.isLoading) {
                  ...
                  return BlocBuilder<ProductBloc, ProductState>(
                    builder: (context, productState) {
                      if (productState.isLoading) {
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(otherUserName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                        ...
                        return Center(
                          child: Text(AppLocalizations.of(context)!.errorObtainingProducts, style: const TextStyle(fontSize: 16)),
                        );
                      }
                    },
                  );
                  ...
                  return Center(
                    child: Text(AppLocalizations.of(context)!.errorObtainingChats, style: const TextStyle(fontSize: 16)),
                  );
                }
              },
            );
