...
//alert para mostrar un qr para intercambio de productos
class AlertShowQRExchange extends StatefulWidget {
  final int productId;
  final String userId;
  final int productExchangedId;

  const AlertShowQRExchange({
    super.key,
    required this.productId,
    required this.userId,
    required this.productExchangedId,
  });

  @override
  State<AlertShowQRExchange> createState() => _AlertShowQRExchangeState();
}

class _AlertShowQRExchangeState extends State<AlertShowQRExchange> {
  @override
  void initState() {
    super.initState();
    context.read<QRBloc>().add(GetQRExchangeButtonPressed(productId: widget.productId, userId: widget.userId, productExchangedId: widget.productExchangedId));
  }
